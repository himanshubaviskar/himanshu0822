...
<div style="margin-top: 80px;height: auto;margin-bottom: 100px;margin-left: 300px">
...
<a href="<c:url value="/UserRegistration"></c:url>" class="float-right btn btn-outline-success"><s:message code="label.userRegistration"></s:message></a>
  ...
  <b>${error}</b>
	...
	<p class="text-center"><a href="<c:url value="/ForgetPassword"/>" class="btn" title="this is for recover password"><s:message
