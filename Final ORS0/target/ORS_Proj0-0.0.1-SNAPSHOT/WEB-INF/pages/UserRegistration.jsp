...
<body>
<div class="signup-form col-md-4" style="margin-top: 80px;height: auto;margin-bottom: 100px;margin-left: 265px">


<sf:form method="post" commandName="form" style="margin-top: -30px;margin-bottom: -30px;">
