...
public class CollegeDAOHibImpl implements CollegeDAOInt {
	...
	/* (non-Javadoc)
	 * @see in.co.sunrays.project0.dao.CollegeDAOInt#add(in.co.sunrays.project0.dto.CollegeDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.sunrays.project0.dao.CollegeDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.sunrays.project0.dao.CollegeDAOInt#findByName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.sunrays.project0.dao.CollegeDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.sunrays.project0.dao.CollegeDAOInt#search(in.co.sunrays.project0.dto.CollegeDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.sunrays.project0.dao.CollegeDAOInt#search(in.co.sunrays.project0.dto.CollegeDTO, int, int)
	 */
