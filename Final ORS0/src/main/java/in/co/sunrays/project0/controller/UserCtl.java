...
private static Logger log = Logger.getLogger(UserCtl.class);
	...
	public String submitUser(@RequestParam String operation, Model model, Locale locale, @ModelAttribute("form") @Valid UserForm form, BindingResult bindingResult, HttpSession session,RedirectAttributes attributes) {
