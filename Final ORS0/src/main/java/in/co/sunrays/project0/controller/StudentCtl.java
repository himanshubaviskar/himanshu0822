...
private static Logger log = Logger.getLogger(StudentCtl.class);
	...
	public void preload(Model model) {
		...
		model.addAttribute("collegeListS",collegeService.search(null));
	...
	public String submit(@RequestParam(required=false) String operation, @ModelAttribute("form") @Valid StudentForm form, BindingResult bindingResult, Model model, HttpSession session, Locale locale, RedirectAttributes attributes) throws DuplicateRecordException, ApplicationException {
...
return "Student";
	...
	public String display(@ModelAttribute("form") StudentForm form, Model model,Locale locale) {
		...
		model.addAttribute("listS",service.search(null, form.getPageNo(),form.getPageSize()));
		int pageNo = 1;
