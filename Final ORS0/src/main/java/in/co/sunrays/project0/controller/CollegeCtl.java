...
public class CollegeCtl extends BaseCtl {
	...
	public String submit(@RequestParam String operation, Model model, @ModelAttribute("form") @Valid CollegeForm form, BindingResult bindingResult, HttpSession session, Locale locale, RedirectAttributes attributes) {
