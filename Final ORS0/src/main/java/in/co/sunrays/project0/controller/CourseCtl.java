...
private static Logger log = Logger.getLogger(CourseCtl.class);
	...
	public String submit(@RequestParam String operation, Model model, Locale locale, @ModelAttribute("form") @Valid CourseForm form, BindingResult bindingResult, HttpSession session,RedirectAttributes attributes) {
